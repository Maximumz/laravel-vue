      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
              ...
              <div class="hidden sm:flex sm:items-center sm:ml-6">
                  ...
                  <!-- Cart / Login / Register / Dashboard -->
                  <jet-nav-link :href="route('cart')" :active="route().current('cart')">
                      Cart
                  </jet-nav-link>
                  <div v-if="$page.props.canLogin" class="hidden top-0 right-0 px-6 py-4 sm:block">
                      ...
                      <template v-else>
                        ...
                        |
                        <jet-nav-link v-if="$page.props.canRegister" :href="route('register')">
                            Register
                        </jet-nav-link>
                      </template>
                  </div>
                      ...
                      <jet-dropdown align="right" width="48">
                          <template #trigger>
                              <button v-if="$page.props.jetstream.managesProfilePhotos" class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition">
                                  <img v-if="$page.props.user" class="h-8 w-8 rounded-full object-cover" :src="$page.props.user.profile_photo_url" :alt="$page.props.user.name" />
                              </button>
      ...
      <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
              ...
              <div class="mt-3 space-y-1">
                <div v-if="$page.props.canLogin" class="top-0 right-0 px-6 py-4 sm:block">
